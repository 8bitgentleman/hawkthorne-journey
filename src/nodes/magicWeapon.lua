...
function Weapon.new(node, collider, plyr, weaponItem)
  ...
  weapon.action = props.action or 'wieldaction3'
  weapon.actionwalk = props.actionwalk or 'wieldaction3'
  weapon.actionjump = props.actionjump or 'wieldaction3'
